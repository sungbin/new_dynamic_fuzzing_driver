...
int api_0 (FuzzedDataProvider& provider) {
  ...
  DEBUG_PRINT(("DEBUG:\t: obj_0_idx: %d, input_1: %d \n", obj_0_idx, input_1));
...
int api_4 (FuzzedDataProvider& provider) {
  ...
  DEBUG_PRINT(("DEBUG:\t: obj_0_idx: %d, obj_1_idx: %d \n", obj_0_idx, obj_1_idx));
...
int api_6 (FuzzedDataProvider& provider) {
  ...
  DEBUG_PRINT(("DEBUG:\t: obj_0_idx: %d, input_1_size: %d - ", obj_0_idx, input_1_size));
...
int api_9 (FuzzedDataProvider& provider) {
  ...
  DEBUG_PRINT(("DEBUG:\t: obj_0_idx: %d, input_1_size: %d - ", obj_0_idx, 200));
  DEBUG_PRINT_ARRAY(input_1, 200);
  if (0x0 ==(void*)obj_0) return -1;
